...
// Toggel Buttons
$(document).ready(function () {
  $('.toggle-btns .btn').click(function () {
    // Remove primary class from all links and add outline primary
    $('.toggle-btns .btn').removeClass('btn-primary').addClass('btn-outline-primary');
    // Add primary class to the clicked link and remove outline primary
...
$(document).ready(function () {
  $('.toggle-btn-group .btn').click(function () {
    // Remove primary class from all links and add outline primary
    $('.toggle-btn-group .btn').removeClass('btn-primary').addClass('btn-outline-primary');
    // Add primary class to the clicked link and remove outline primary
    $(this).addClass('btn-primary').removeClass('btn-outline-primary');
  });
});
...
// Card Full Screen
function toggleCardFullscreen(cardId, toggleButtonId, fullscreenClass) {
...
// Call the function only if the elements exist
if (document.getElementById("toggleCardFullscreen") && document.getElementById("cardFullscreen")) {
